...
Ko.PoC.ViewModels.DemoViewModel = function (rawData, parent, defaults, mappingOptions) {
    var self = this;
    
    defaults = $.extend({}, {"RequiredModel":null,"RegexModel":null,"MinMaxModel":null}, defaults);
