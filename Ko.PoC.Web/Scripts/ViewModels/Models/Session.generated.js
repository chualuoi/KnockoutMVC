...
Ko.PoC.Models.Session = function (rawData, parent, defaults, mappingOptions) {
    var self = this;
    
    defaults = $.extend({}, {"Name":null,"Speaker":null}, defaults);
    
    mappingOptions = $.extend({}, {
        'ignore': [],
        Speaker:{
            create: function(options){
                return ko.observable(new Ko.PoC.Models.Person(options.data, self));
            }
        }    
    }, mappingOptions);	
